...
class MessageCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        /* 在初始化時，設置對話泡泡有靠左和靠右兩種 constraint，但狀態皆預設為 false
         * 當對話訊息 didSet 後，再決定啟用靠左或靠右的約束 */
        bubbleLeftAnchor = bubbleContainer.leftAnchor
            .constraint(equalTo: profileImageView.rightAnchor, constant: 12)
        bubbleLeftAnchor.isActive = false
        bubbleRightAnchor = bubbleContainer.rightAnchor
            .constraint(equalTo: rightAnchor, constant: -12)
